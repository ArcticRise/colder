...
public class BookCollectionView extends View
{
	...
	private VBox createFormContent()
	{
        ...
        Text prompt = new Text("List of Books with a simalar author");
		...
		TableColumn accountNumberColumn = new TableColumn("Book Id") ;
		...
		TableColumn accountTypeColumn = new TableColumn("Author") ;
	...
	TableColumn stateCodeCol = new TableColumn("Status") ;
		...
		tableOfAccounts.getColumns().addAll(accountNumberColumn, 
				accountTypeColumn, balanceColumn, serviceChargeColumn,stateCodeCol);
